...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'roadkill_templates')
    DROP TABLE [roadkill_templates];
...
CREATE TABLE [dbo].[roadkill_templates]
(
	[Id] [uniqueidentifier] NOT NULL,
...
SET IDENTITY_INSERT roadkill_templates ON;
