...
namespace Roadkill.Core.Mvc.ViewModels
{
    ...
    public class PageViewModel
    {
        ...
        {
            get { return PageViewModel.EncodePageTitle(Title); }
        }
        ...
        /// <summary>
        /// Retrieves all templates in the system. This is empty unless filled by the controller.
        /// </summary>
        [XmlIgnore]
        public List<SelectListItem> AllTemplates { get; set; }

        /// <summary>
        /// Stores the template used for the page
        /// </summary>
        ...
        public PageViewModel()
        {
            ...
            AllTemplates = new List<SelectListItem>();
        ...
        {
            if (!string.IsNullOrEmpty(Content) || Template == null) return;
            Content = Template.Content; // Set content as template if it's empty or null
            
            if (!string.IsNullOrEmpty(Template.Name))
                _tags.Add(Template.Name); // Tag the page as the template (server,database,project)
        }
        ...
        public static ValidationResult VerifyRawTags(PageViewModel pageViewModel, ValidationContext context)
        {
            ...
            {
                return new ValidationResult("Invalid characters in tag");
                    // doesn't need to be localized as there's a javascript check
            }
            else
            {
                return ValidationResult.Success;
        ...
        public static string EncodePageTitle(string title)
        {
            ...
            title = Regex.Replace(title, @"[^\w\d\s-]", "");
                // this is unicode safe, but may need to revert back to 'a-zA-Z0-9', need to check spec
