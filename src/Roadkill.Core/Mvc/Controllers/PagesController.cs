...
namespace Roadkill.Core.Mvc.Controllers
{
	...
	public class PagesController : ControllerBase
	{
		...
		public PagesController(ApplicationSettings settings, UserServiceBase userManager,
			...
			PageHistoryService historyService, TemplateService templateService, IUserContext context)
		...
		public ActionResult Edit(int id)
		{
			...
			if (model != null)
			{
                ...
                //model.AllTemplates = TemplateViewModel.MakeDropDownList(_templateService.AllTemplates());
                //Commented out so that the templates don't come up on an edit page. 
		...
		/// <remarks>This action requires editor rights.</remarks>
		[EditorRequired]
        public ActionResult New(string title = "", string tags = "", string id = "", int intId = 0)
		{
		    ...
		    if (id != "")
		    {
		        try
		        {
		            ...
		            template = _templateService.GetById(intId);
		        }
