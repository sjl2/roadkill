...
namespace Roadkill.Core.Database.LightSpeed
{
	...
	public class FromEntity
	{
        ...
        public static Template ToTemplate(TemplateEntity entity)
        {
            if (entity == null)
                return null;
            ...
            template.Content = entity.Content;
        ...
        public static IEnumerable<Template> ToTemplateList(List<TemplateEntity> entities)
        {
            List<Template> list = new List<Template>();
            foreach (TemplateEntity entity in entities)
            {
                Template template = ToTemplate(entity);
                list.Add(template);
            }
