...
(function (Roadkill) {
    ...
    (function (Web) {
        var EditTemplate = (function () {
            ...
            */
            EditTemplate.prototype.initializeTagManager = function (tags) {
                var _this = this;
            ...
            */
            EditTemplate.prototype.isValidTag = function (tag) {
            ...
            EditTemplate.prototype.bindPreview = function () {
                var _this = this;
                ...
                $("#Content").on("keydown", function () {
                    ...
                    _this._timeout = setTimeout(Web.EditPage.updatePreviewPane, 100);
                });
            };

            EditTemplate.prototype.bindPreviewToggleButton = function () {
            ...
            EditTemplate.prototype.resizePreviewPane = function () {
            ...
            */
            EditTemplate.updatePreviewPane = function () {
                $("#previewLoading").show();
