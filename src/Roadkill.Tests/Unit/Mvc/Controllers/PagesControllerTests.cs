...
namespace Roadkill.Tests.Unit
{
	...
	public class PagesControllerTests
	{
		...
		public void Setup()
		{
            ...
            _templateService = new TemplateService(_applicationSettings, _repository, _pluginFactory);

			_pagesController = new PagesController(_applicationSettings, _userService, _settingsService, _pageService, _searchService, _historyService, _templateService, _contextStub);
